...
public class EditProfileActivity extends AppCompatActivity {
    ...
    EditText mFName, mLName, mEmail, mPhone;
    Button mSaveBtn;
    CircleImageView mUerImg;
    ...
    private void initViews() {
        ...
        mUerImg = findViewById(R.id.user_profile);
        mUerImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openFile();
            }
    ...
    void setDataFromSharedPrefences() {
        mFName.setText(mSessionMangment.getUserDetails().get(SessionMangment.KEY_FNAME));
        mLName.setText(mSessionMangment.getUserDetails().get(SessionMangment.KEY_LNAME));
        mEmail.setText(mSessionMangment.getUserDetails().get(SessionMangment.KEY_EMAIL));
...
//                Glide.with(getActivity()).load(mFilePath).into(iUserImage);
//                Log.e("mFilePath", mFilename+"");
//                if (mFilePath != null) {
//
//
//
//
//
//                    mViewModel.uploadCVToServer(mFilename, "1");
